...
import static af.settings.AppPropertyType.LOAD_ERROR_MESSAGE;
import static af.settings.AppPropertyType.LOAD_ERROR_TITLE;
import static af.settings.AppPropertyType.LOAD_WORK_TITLE;
import static af.settings.AppPropertyType.WORK_FILE_EXT;
import static af.settings.AppPropertyType.WORK_FILE_EXT_DESC;
import static af.settings.AppPropertyType.NEW_COMPLETED_MESSAGE;
import static af.settings.AppPropertyType.NEW_COMPLETED_TITLE;
import static af.settings.AppPropertyType.NEW_ERROR_MESSAGE;
import static af.settings.AppPropertyType.NEW_ERROR_TITLE;
import static af.settings.AppPropertyType.SAVE_COMPLETED_MESSAGE;
import static af.settings.AppPropertyType.SAVE_COMPLETED_TITLE;
import static af.settings.AppPropertyType.SAVE_ERROR_MESSAGE;
import static af.settings.AppPropertyType.SAVE_ERROR_TITLE;
import static af.settings.AppPropertyType.SAVE_UNSAVED_WORK_MESSAGE;
import static af.settings.AppPropertyType.SAVE_UNSAVED_WORK_TITLE;
