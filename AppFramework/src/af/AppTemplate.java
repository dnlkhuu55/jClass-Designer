...
import static af.settings.AppPropertyType.APP_TITLE;
import static af.settings.AppPropertyType.PROPERTIES_LOAD_ERROR_MESSAGE;
import static af.settings.AppPropertyType.PROPERTIES_LOAD_ERROR_TITLE;
import static af.settings.AppStartupConstants.PATH_DATA;
import static af.settings.AppStartupConstants.PROPERTIES_SCHEMA_FILE_NAME;
import static af.settings.AppStartupConstants.SIMPLE_APP_PROPERTIES_FILE_NAME;
import static af.settings.AppStartupConstants.WORKSPACE_PROPERTIES_FILE_NAME;
